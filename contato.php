          ...
          <?php if (isset($_SESSION['id'])) { ?>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="perfil.php">Perfil
          ...
          <section class="estilo-form  m-auto d-flex align-items-center w-75 gap-5">
            ...
            <form action="https://formspree.io/f/xbjvbldj" method="post" class="b-2">
              ...
              <div class="form-floating">
                <textarea class="form-control" name="mensagem" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px"></textarea>
