...
$primeiroInput = filter_input(INPUT_POST, 'first', FILTER_SANITIZE_SPECIAL_CHARS);

$segundoInput = filter_input(INPUT_POST, 'segundo', FILTER_SANITIZE_SPECIAL_CHARS);

$terceiroInput = filter_input(INPUT_POST, 'terceiro', FILTER_SANITIZE_SPECIAL_CHARS);

$quartoInput = filter_input(INPUT_POST, 'quarto', FILTER_SANITIZE_SPECIAL_CHARS);

$quintoInput = filter_input(INPUT_POST, 'mensagem', FILTER_SANITIZE_SPECIAL_CHARS);
