...
<body>
    ...
    <article class="d-flex flex-column bg-primary w-50 ms-5">
        ...
        <p class="fs-3 text-wrap lh-lg text-primary">Integrantes: Eduardo,Kauê, Nicolas e Zimbo.
        </p>
    
    </article>
    <div class="d-flex flex-row-reverse bg-warning align-self-center">
            <img src="../images/mina.png" alt="imagem-provisoria" width="50%">
    </div>
